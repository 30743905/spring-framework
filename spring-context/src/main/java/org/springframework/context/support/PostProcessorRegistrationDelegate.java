...
final class PostProcessorRegistrationDelegate {
	...
	/**
	 * BeanDefinitionRegistryPostProcessors 手动注册的 BeanFactoryPostProcessor 以及通过配置文件方式的 BeanFactoryPostProcessor 按照 PriorityOrdered 、 Ordered、no ordered 三种方式分开处理、调用。
	 * @param beanFactory
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			// 保存spring内部自己实现的BeanDefinitionRegistryPostProcessor
	...
	public static void registerBeanPostProcessors(
		...
		//最终，重新注册internal的后置器，即MergedBeanDefinitionPostProcessor类型的后置处理器
		 ...
		 * ApplicationListenerDetector:在Bean创建完成后，用来检查是否是ApplicationListener类型，
		 * 如果是则this.applicationContext.addApplicationListener((ApplicationListener<?>) bean);保存到listener容器中
		 */
